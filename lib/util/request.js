...
Request.prototype.get = function ( url ) {
	...
	let request = superagent.get( url ).timeout( this.wpcomVIP.API_TIMEOUT );
...
Request.prototype.post = function ( url ) {
	...
	let request = superagent.post( url ).timeout( this.wpcomVIP.API_TIMEOUT );
...
Request.prototype.put = function ( url ) {
	...
	let request = superagent.put( url ).timeout( this.wpcomVIP.API_TIMEOUT );
...
Request.prototype.patch = function ( url ) {
	...
	let request = superagent.patch( url ).timeout( this.wpcomVIP.API_TIMEOUT );
...
Request.prototype.del = function ( url ) {
	...
	let request = superagent.del( url ).timeout( this.wpcomVIP.API_TIMEOUT );
